                    ...
                    Expanded(child: Padding(
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(padding: EdgeInsets.only(bottom: 5.0), child: Text(item.recReason ?? "", maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Color(0xFF9F9F9F), fontSize: 15.0),),),
                            Padding(padding: EdgeInsets.only(bottom: 5.0), child: Text(item.albumLabel ?? "", maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Color(0xFF9F9F9F), fontSize: 15.0),),),
